...
public final class PMGClass extends Attribute
{
	...
	this(c.getNameIndex(), c.getLength(), c.getPMGIndex(),
	     c.getPMGClassIndex(), c.getConstantPool());
    }
	...
	ConstantUtf8 c
	    = (ConstantUtf8) constant_pool.getConstant(pmg_index, (byte) 1);
	return c.getBytes();
    }
	...
	ConstantUtf8 c
	    = ((ConstantUtf8)
	       constant_pool.getConstant(pmg_class_index, (byte) 1));
	return c.getBytes();
    }
    
    public final String toString() {
	return new StringBuilder().append("PMGClass(").append(getPMGName())
		   .append
		   (", ").append
		   (getPMGClassName()).append
		   (")").toString();
    }
