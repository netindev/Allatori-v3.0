...
public final class Signature extends Attribute
{
	...
	if (!identStart(ch)) {
	    ...
	    int count = 1;
	    for (/**/; Character.isJavaIdentifierPart((char) ch);
		 ch = in.read()) {
		buf2.append((char) ch);
		count++;
	    }
	...
	return new StringBuilder().append("Signature(").append(s).append
		   (")").toString();
    }
