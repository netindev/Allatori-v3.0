/* ParameterAnnotations - Decompiled by JODE
...
public abstract class ParameterAnnotations extends Attribute
{
    ...
    ParameterAnnotations(byte parameter_annotation_type, int name_index,
			 int length, DataInputStream file,
	...
	parameter_annotation_table
	    = new ParameterAnnotationEntry[num_parameters];
	for (int i = 0; i < num_parameters; i++)
	    parameter_annotation_table[i]
		= new ParameterAnnotationEntry(file, constant_pool);
    }
    
    public ParameterAnnotations
	(byte parameter_annotation_type, int name_index, int length,
