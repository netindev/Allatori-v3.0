/* EnclosingMethod - Decompiled by JODE
...
public class EnclosingMethod extends Attribute
{
    ...
    private EnclosingMethod(int nameIndex, int len, int classIdx,
			    int methodIdx, ConstantPool cpool) {
	...
	ConstantClass c
	    = (ConstantClass) constant_pool.getConstant(classIndex, (byte) 7);
	return c;
    }
	...
	ConstantNameAndType nat
	    = ((ConstantNameAndType)
	       constant_pool.getConstant(methodIndex, (byte) 12));
	return nat;
    }
