...
public class SimpleElementValue extends ElementValue
{
	...
	ConstantUtf8 c
	    = (ConstantUtf8) cpool.getConstant(getIndex(), (byte) 1);
	return c.getBytes();
    }
	...
	if (type != 73)
	    throw new RuntimeException
		      ("Dont call getValueString() on a non STRING ElementValue");
	ConstantInteger c
	    = (ConstantInteger) cpool.getConstant(getIndex(), (byte) 3);
	return c.getBytes();
    }
	...
	case 74: {
	    ConstantLong j
		= (ConstantLong) cpool.getConstant(getIndex(), (byte) 5);
	    return Long.toString(j.getBytes());
	}
	case 68: {
	    ConstantDouble d
		= (ConstantDouble) cpool.getConstant(getIndex(), (byte) 6);
	    return Double.toString(d.getBytes());
	}
	case 70: {
	    ConstantFloat f
		= (ConstantFloat) cpool.getConstant(getIndex(), (byte) 4);
