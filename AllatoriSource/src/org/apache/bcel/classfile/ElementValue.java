...
public abstract class ElementValue
{
    ...
    public static ElementValue readElementValue
	...
	case 101:
	    return new EnumElementValue(101, dis.readUnsignedShort(),
					dis.readUnsignedShort(), cpool);
	case 99:
	    return new ClassElementValue(99, dis.readUnsignedShort(), cpool);
	case 64:
	    return new AnnotationElementValue(64,
					      AnnotationEntry.read(dis, cpool,
								   false),
					      cpool);
	case 91: {
