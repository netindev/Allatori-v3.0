...
final class MethodHTML implements Constants
{
	...
	file.print(new StringBuilder().append
		       ("<TR><TD><FONT COLOR=\"#FF0000\">").append
		       (access).append
		       ("</FONT></TD>\n<TD>").append
		       (Class2HTML.referenceType(type)).append
		       ("</TD><TD><A NAME=\"field").append
		       (name).append
		       ("\">").append
		       (name).append
		       ("</A></TD>").toString());
	...
	for (int i = 0; i < attributes.length; i++) {
		...
		file.print(new StringBuilder().append("<TD>= <A HREF=\"")
			       .append
			       (class_name).append
	...
	file.print
	    (new StringBuilder().append
		 ...
		 (access).append
		 ("</A></FONT></TD>").toString());
	file.print(new StringBuilder().append("<TD>").append
		       (Class2HTML.referenceType(type)).append
		       ("</TD><TD>").append
		       ("<A HREF=").append
		       (class_name).append
