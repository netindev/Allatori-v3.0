...
public class EnumElementValueGen extends ElementValueGen
{
	...
	System.err.println(new StringBuilder().append
            ("Duplicating value: ").append
            (getEnumTypeString()).append
            (":").append
            (getEnumValueString()).toString());
	return new EnumElementValue(type, typeIdx, valueIdx,
				    cpGen.getConstantPool());
    }
    
    public EnumElementValueGen(ObjectType t, String value,
			       ConstantPoolGen cpool) {
	super(101, cpool);
	...
	ConstantUtf8 cu8
	    = (ConstantUtf8) getConstantPool().getConstant(valueIdx);
	return cu8.getBytes();
    }
