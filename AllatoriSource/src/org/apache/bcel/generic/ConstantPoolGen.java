...
public class ConstantPoolGen implements Serializable {
	...
	public int lookupNameAndType(String name, String signature) {
		Index _index = (Index) n_a_t_table
	...
	public int addNameAndType(String name, String signature) {
		...
		String key = new StringBuilder().append(name).append("%").append(signature).toString();
		if (!n_a_t_table.containsKey(key))
	...
	public int lookupMethodref(String class_name, String method_name, String signature) {
		Index index = (Index) cp_table.get(new StringBuilder().append(class_name).append(":").append(method_name)
	...
	public int addMethodref(String class_name, String method_name, String signature) {
		...
		String key = new StringBuilder().append(class_name).append(":").append(method_name).append(":")
	...
	public int lookupFieldref(String class_name, String field_name, String signature) {
		Index index = (Index) cp_table.get(new StringBuilder().append(class_name).append("&").append(field_name)
				.append("&").append(signature).toString());
		return index != null ? index.index : -1;
	}
	...
	public int addFieldref(String class_name, String field_name, String signature) {
		...
		String key = new StringBuilder().append(class_name).append("&").append(field_name).append("&").append(signature)
				.toString();
		if (!cp_table.containsKey(key))
			cp_table.put(key, new Index(ret));
		return ret;
