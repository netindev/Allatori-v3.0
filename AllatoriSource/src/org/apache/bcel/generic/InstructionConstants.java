/* InstructionConstants - Decompiled by JODE
...
public interface InstructionConstants
{
	...
	Clinit() {
	    ...
	    InstructionConstants.INSTRUCTIONS[1]
		= InstructionConstants.ACONST_NULL;
	    InstructionConstants.INSTRUCTIONS[2]
		= InstructionConstants.ICONST_M1;
	    InstructionConstants.INSTRUCTIONS[3]
		= InstructionConstants.ICONST_0;
	    InstructionConstants.INSTRUCTIONS[4]
		= InstructionConstants.ICONST_1;
	    InstructionConstants.INSTRUCTIONS[5]
		= InstructionConstants.ICONST_2;
	    InstructionConstants.INSTRUCTIONS[6]
		= InstructionConstants.ICONST_3;
	    InstructionConstants.INSTRUCTIONS[7]
		= InstructionConstants.ICONST_4;
	    InstructionConstants.INSTRUCTIONS[8]
		= InstructionConstants.ICONST_5;
	    InstructionConstants.INSTRUCTIONS[9]
		= InstructionConstants.LCONST_0;
	    InstructionConstants.INSTRUCTIONS[10]
		= InstructionConstants.LCONST_1;
	    InstructionConstants.INSTRUCTIONS[11]
		= InstructionConstants.FCONST_0;
	    InstructionConstants.INSTRUCTIONS[12]
		= InstructionConstants.FCONST_1;
	    InstructionConstants.INSTRUCTIONS[13]
		= InstructionConstants.FCONST_2;
	    InstructionConstants.INSTRUCTIONS[14]
		= InstructionConstants.DCONST_0;
	    InstructionConstants.INSTRUCTIONS[15]
		= InstructionConstants.DCONST_1;
	    InstructionConstants.INSTRUCTIONS[46]
		= InstructionConstants.IALOAD;
	    InstructionConstants.INSTRUCTIONS[47]
		= InstructionConstants.LALOAD;
	    InstructionConstants.INSTRUCTIONS[48]
		= InstructionConstants.FALOAD;
	    InstructionConstants.INSTRUCTIONS[49]
		= InstructionConstants.DALOAD;
	    InstructionConstants.INSTRUCTIONS[50]
		= InstructionConstants.AALOAD;
	    InstructionConstants.INSTRUCTIONS[51]
		= InstructionConstants.BALOAD;
	    InstructionConstants.INSTRUCTIONS[52]
		= InstructionConstants.CALOAD;
	    InstructionConstants.INSTRUCTIONS[53]
		= InstructionConstants.SALOAD;
	    InstructionConstants.INSTRUCTIONS[79]
		= InstructionConstants.IASTORE;
	    InstructionConstants.INSTRUCTIONS[80]
		= InstructionConstants.LASTORE;
	    InstructionConstants.INSTRUCTIONS[81]
		= InstructionConstants.FASTORE;
	    InstructionConstants.INSTRUCTIONS[82]
		= InstructionConstants.DASTORE;
	    InstructionConstants.INSTRUCTIONS[83]
		= InstructionConstants.AASTORE;
	    InstructionConstants.INSTRUCTIONS[84]
		= InstructionConstants.BASTORE;
	    InstructionConstants.INSTRUCTIONS[85]
		= InstructionConstants.CASTORE;
	    InstructionConstants.INSTRUCTIONS[86]
	    ...
	    InstructionConstants.INSTRUCTIONS[90]
		= InstructionConstants.DUP_X1;
	    InstructionConstants.INSTRUCTIONS[91]
		= InstructionConstants.DUP_X2;
	    InstructionConstants.INSTRUCTIONS[92] = InstructionConstants.DUP2;
	    InstructionConstants.INSTRUCTIONS[93]
		= InstructionConstants.DUP2_X1;
	    InstructionConstants.INSTRUCTIONS[94]
	    ...
	    InstructionConstants.INSTRUCTIONS[124]
		= InstructionConstants.IUSHR;
	    InstructionConstants.INSTRUCTIONS[125]
	    ...
	    InstructionConstants.INSTRUCTIONS[149]
		= InstructionConstants.FCMPL;
	    InstructionConstants.INSTRUCTIONS[150]
		= InstructionConstants.FCMPG;
	    InstructionConstants.INSTRUCTIONS[151]
		= InstructionConstants.DCMPL;
	    InstructionConstants.INSTRUCTIONS[152]
		= InstructionConstants.DCMPG;
	    InstructionConstants.INSTRUCTIONS[172]
		= InstructionConstants.IRETURN;
	    InstructionConstants.INSTRUCTIONS[173]
		= InstructionConstants.LRETURN;
	    InstructionConstants.INSTRUCTIONS[174]
		= InstructionConstants.FRETURN;
	    InstructionConstants.INSTRUCTIONS[175]
		= InstructionConstants.DRETURN;
	    InstructionConstants.INSTRUCTIONS[176]
		= InstructionConstants.ARETURN;
	    InstructionConstants.INSTRUCTIONS[177]
		= InstructionConstants.RETURN;
	    InstructionConstants.INSTRUCTIONS[190]
		= InstructionConstants.ARRAYLENGTH;
	    InstructionConstants.INSTRUCTIONS[191]
		= InstructionConstants.ATHROW;
	    InstructionConstants.INSTRUCTIONS[194]
		= InstructionConstants.MONITORENTER;
	    InstructionConstants.INSTRUCTIONS[195]
