...
public abstract class ElementValueGen
{
    ...
    public static ElementValueGen readElementValue
	(DataInputStream dis, ConstantPoolGen cpGen) throws IOException {
	int type = dis.readUnsignedByte();
	switch (type) {
	case 66:
	    return new SimpleElementValueGen(66, dis.readUnsignedShort(),
					     cpGen);
	case 67:
	    return new SimpleElementValueGen(67, dis.readUnsignedShort(),
					     cpGen);
	case 68:
	    return new SimpleElementValueGen(68, dis.readUnsignedShort(),
					     cpGen);
	case 70:
	    return new SimpleElementValueGen(70, dis.readUnsignedShort(),
					     cpGen);
	case 73:
	    return new SimpleElementValueGen(73, dis.readUnsignedShort(),
					     cpGen);
	case 74:
	    return new SimpleElementValueGen(74, dis.readUnsignedShort(),
					     cpGen);
	case 83:
	    return new SimpleElementValueGen(83, dis.readUnsignedShort(),
					     cpGen);
	case 90:
	    return new SimpleElementValueGen(90, dis.readUnsignedShort(),
					     cpGen);
	case 115:
	    return new SimpleElementValueGen(115, dis.readUnsignedShort(),
					     cpGen);
	case 101:
	...
	case 64:
	    return (new AnnotationElementValueGen
		    (64, (new AnnotationEntryGen
			  (AnnotationEntry.read(dis, cpGen.getConstantPool(),
						true),
			   cpGen, false)), cpGen));
	case 91: {
		...
		evalues[j]
		    = ElementValue.readElementValue(dis,
	...
	(ElementValue value, ConstantPoolGen cpool, boolean copyPoolEntries) {
	...
	default:
	    throw new RuntimeException(new StringBuilder().append
					   ...
					   (value.getElementValueType()).append
					   (")").toString());
	}
    }
}
