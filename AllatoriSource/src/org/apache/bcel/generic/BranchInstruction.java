/* BranchInstruction - Decompiled by JODE
    ...
    implements InstructionTargeter
{
	...
	if (verbose) {
	    ...
	    index = getTargetOffset();
	    t = new StringBuilder().append("").append(index + position)
		    .toString();
	}
	return new StringBuilder().append(s).append(" -> ").append(t)
		   .toString();
    }
