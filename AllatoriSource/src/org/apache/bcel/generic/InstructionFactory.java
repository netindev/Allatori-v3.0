...
public class InstructionFactory implements InstructionConstants, Serializable
{
	...
	return type instanceof ObjectType && ((ObjectType) type).getClassName
	...
	if (src_type instanceof BasicType && dest_type instanceof BasicType) {
		...
		src = (byte) 10;
	    String name
		= new StringBuilder().append("org.apache.bcel.generic.").append
		      (short_names[src - 5]).append
		      ("2").append
		      (short_names[dest - 5]).toString();
	    Instruction i = null;
	    try {
	...
	if (src_type instanceof ReferenceType
