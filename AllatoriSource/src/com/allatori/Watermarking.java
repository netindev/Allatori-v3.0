...
public class Watermarking {
	...
	public String extractWatermark() throws Exception_Sub1 {
		try {
			final Vector<Class171> vector = this.method1761();
			final short[] arrShort = this.method1759(vector);
	...
	private short[] method1759(Vector<Class171> parVector) {
		...
		final short[] arrShort = new short[vector.size()];
		for (int i = arrShort.length - 1; i >= 0; i--) {
			arrShort[i] = vector.get(i).shortValue();
		}
		return arrShort;
	}
	...
	private String method1765(short[] var1) throws Exception {
		...
		if (var19 == -1) {
			...
			for (var10000 = var11; var10000 < var10.length; var10000 = var11) {
				var12 = var7.get(new Short(var1[var12 + 1])).shortValue();
				int var10001 = var11++;
	...
	public void createWatermark(String var1) throws Exception_Sub1 {
		try {
			final Vector<Class171> var2 = this.method1761();
