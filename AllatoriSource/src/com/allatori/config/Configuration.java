...
public class Configuration {
    ...
    protected static ClassStorage method1269() throws Exception {
    ...
    public static String printSplash() {
        String var0 = " ## #   #    ## ### ### ##  ###";
        String var1 = "# # #   #   # #  #  # # # #  # ";
        String var2 = "### #   #   ###  #  # # ##   # ";
        String var3 = "# # ### ### # #  #  ### # # ###";
    ...
    protected static String method1274(ClassStorage var0) throws Exception_Sub1 {
        return (new Watermarking(var0, Class167.method1660())).extractWatermark();
    }

    protected static void method1275(ClassStorage var0) throws Exception {
        method1268(var0);
        method1273(var0);
    }
}
