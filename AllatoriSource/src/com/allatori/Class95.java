...
public class Class95 {
    ...
    private void method1249(Attribute[] var1, ConstantPool var2) {
        ...
        for (int var10000 = var3 = var1.length - 1; var10000 >= 0; var10000 = var3) {
            ...
            if (var4 instanceof Code) {
                ...
                ConstantValue var15;
                (var15 = (ConstantValue) var4).setConstantValueIndex(this.mappedNameCPReferences[var15.getConstantValueIndex()]);
            } else if (!(var4 instanceof Deprecated)) {
                if (var4 instanceof ExceptionTable) {
                    ExceptionTable var17;
                    int[] var21;
                    for (var10000 = var7 = (var21 = (var17 = (ExceptionTable) var4).getExceptionIndexTable()).length - 1; var10000 >= 0; var10000 = var7) {
                    ...
                    InnerClass[] var19;
                    for (var10000 = var7 = (var19 = ((InnerClasses) var4).getInnerClasses()).length - 1; var10000 >= 0; var10000 = var7) {
                    ...
                    if (var4 instanceof LocalVariableTable) {
                        try {
                            LocalVariable[] var24;
                            for (var10000 = var7 = (var24 = ((LocalVariableTable) var4).getLocalVariableTable()).length - 1; var10000 >= 0; var10000 = var7) {
                                var24[var7].setNameIndex(this.mappedNameCPReferences[var24[var7].getNameIndex()]);
                                var24[var7].setSignatureIndex(this.mappedNameCPReferences[var24[var7].getSignatureIndex()]);
                                --var7;
                            }
                        ...
                        PMGClass var18;
                        (var18 = (PMGClass) var4).setPMGClassIndex(this.mappedNameCPReferences[var18.getPMGClassIndex()]);
                        var18.setPMGIndex(this.mappedNameCPReferences[var18.getPMGIndex()]);
                    } else if (var4 instanceof Signature) {
                        Signature var25;
                        (var25 = (Signature) var4).setSignatureIndex(this.mappedNameCPReferences[var25.getSignatureIndex()]);
                    } else if (var4 instanceof SourceFile) {
                        SourceFile var22;
                        (var22 = (SourceFile) var4).setSourceFileIndex(this.mappedNameCPReferences[var22.getSourceFileIndex()]);
                    } else if (var4 instanceof StackMap) {
                        StackMapEntry[] var23;
                        for (var10000 = var7 = (var23 = ((StackMap) var4).getStackMap()).length - 1; var10000 >= 0; var10000 = var7) {
                            StackMapType[] var9;
                            int var10;
                            StackMapEntry var28;
                            for (var10000 = var10 = (var9 = (var28 = var23[var7]).getTypesOfLocals()).length - 1; var10000 >= 0; var10000 = var10) {
                                StackMapType var11;
                            ...
                            int var12;
                            StackMapType[] var30;
                            for (var10000 = var12 = (var30 = var28.getTypesOfStackItems()).length - 1; var10000 >= 0; var10000 = var12) {
                                StackMapType var13;
                        ...
                        if (var4 instanceof EnclosingMethod) {
                            ...
                            (var26 = (EnclosingMethod) var4).setEnclosingClassIndex(this.mappedNameCPReferences[var26.getEnclosingClassIndex()]);
                            if (var26.getEnclosingMethodIndex() != 0) {
                                var26.setEnclosingMethodIndex(this.mappedNameCPReferences[var26.getEnclosingMethodIndex()]);
                            }
                        } else if (var4 instanceof AnnotationDefault) {
                            AnnotationDefault var29;
                            ElementValueGen var31 = ElementValueGen.copy((var29 = (AnnotationDefault) var4).getDefaultValue(), new ConstantPoolGen(var2), false);
    ...
    private void method1250(ClassGen var1) {
        ...
        int var3 = (var2 = var1.getConstantPool()).getSize();
        int var4 = 0;
        ...
        Constant[] var6 = new Constant[var4];
        int var7 = 0;
        ...
        ConstantPool var26 = (var25 = new ConstantPoolGen(var6)).getConstantPool();
        ...
        Attribute[] var12;
        int var13 = (var12 = var1.getAttributes()).length;
        ...
        for (var10000 = var17 = (var16 = var1.getMethods()).length - 1; var10000 >= 0; var10000 = var17) {
            Method var18;
            MethodGen var19 = InitUtils.createMethodGen(var18 = var16[var17], var1.getClassName(), var25, var2.getConstantPool());
    ...
    private void method1253(MethodGen var1, ConstantPoolGen var2) {
        ...
        if ((var3 = var1.getInstructionList()) != null) {
            ...
            int var5;
            for (int var10000 = var5 = (var4 = var3.getInstructionHandles()).length - 1; var10000 >= 0; var10000 = var5) {
                Instruction var7 = var4[var5].getInstruction();
                if (var7 instanceof CPInstruction) {
                    CPInstruction var8 = (CPInstruction) var7;
    ...
    private void method1255(Attribute[] var1, ConstantPoolGen var2) {
        ...
        for (int var10000 = var3 = var1.length - 1; var10000 >= 0; var10000 = var3) {
            ...
            if (var4 instanceof Code) {
                ...
                ConstantValue var14 = (ConstantValue) var4;
                this.method1260(var14.getConstantValueIndex(), var2);
            } else if (!(var4 instanceof Deprecated)) {
                if (var4 instanceof ExceptionTable) {
                    ExceptionTable var16;
                    int[] var20;
                    for (var10000 = var7 = (var20 = (var16 = (ExceptionTable) var4).getExceptionIndexTable()).length - 1; var10000 >= 0; var10000 = var7) {
                    ...
                    InnerClasses var15;
                    InnerClass[] var18;
                    for (var10000 = var7 = (var18 = (var15 = (InnerClasses) var4).getInnerClasses()).length - 1; var10000 >= 0; var10000 = var7) {
                    ...
                    if (var4 instanceof LocalVariableTable) {
                        LocalVariableTable var19;
                        LocalVariable[] var23;
                        for (var10000 = var7 = (var23 = (var19 = (LocalVariableTable) var4).getLocalVariableTable()).length - 1; var10000 >= 0; var10000 = var7) {
                            this.method1260(var23[var7].getNameIndex(), var2);
                            this.method1260(var23[var7].getSignatureIndex(), var2);
                            --var7;
                        }
                    } else if (var4 instanceof PMGClass) {
                        PMGClass var17 = (PMGClass) var4;
                        this.method1260(var17.getPMGClassIndex(), var2);
                        this.method1260(var17.getPMGIndex(), var2);
                    } else if (var4 instanceof Signature) {
                        Signature var24 = (Signature) var4;
                        this.method1260(var24.getSignatureIndex(), var2);
                    } else if (var4 instanceof SourceFile) {
                        SourceFile var21 = (SourceFile) var4;
                        this.method1260(var21.getSourceFileIndex(), var2);
                    } else if (var4 instanceof StackMap) {
                        StackMapEntry[] var22;
                        StackMap var26;
                        for (var10000 = var7 = (var22 = (var26 = (StackMap) var4).getStackMap()).length - 1; var10000 >= 0; var10000 = var7) {
                            StackMapEntry var8;
                            StackMapType[] var9;
                            int var10;
                            for (var10000 = var10 = (var9 = (var8 = var22[var7]).getTypesOfLocals()).length - 1; var10000 >= 0; var10000 = var10) {
                                StackMapType var11;
                                if ((var11 = var9[var10]).getType() == 7) {
                            ...
                            int var12;
                            StackMapType[] var28;
                            for (var10000 = var12 = (var28 = var8.getTypesOfStackItems()).length - 1; var10000 >= 0; var10000 = var12) {
                                StackMapType var13;
                        ...
                        if (var4 instanceof EnclosingMethod) {
                            EnclosingMethod var25 = (EnclosingMethod) var4;
                            ...
                            AnnotationDefault var27;
                            ElementValueGen var29 = ElementValueGen.copy((var27 = (AnnotationDefault) var4).getDefaultValue(), var2, false);
    ...
    private void method1256(ClassGen var1) {
        ...
        for (var10000 = var7 = (var6 = var1.getMethods()).length - 1; var10000 >= 0; var10000 = var7) {
            ...
            MethodGen var9 = InitUtils.createMethodGen(var8, var1.getClassName(), var2, var2.getConstantPool());
        ...
        for (var10000 = var10 = var2.getSize() - 1; var10000 >= 0; var10000 = var10) {
            ...
            if ((var11 = var2.getConstant(var10)) instanceof ConstantUtf8) {
                ConstantUtf8 var12 = (ConstantUtf8) var11;
    ...
    private void method1257(AnnotationEntryGen var1) {
        ...
        for (int var10000 = var3 = (var2 = var1.getValues()).size() - 1; var10000 >= 0; var10000 = var3) {
            ...
            (var4 = (ElementValuePairGen) var2.get(var3)).setNameIndex(this.mappedNameCPReferences[var4.getNameIndex()]);
    ...
    private void method1260(int var1, ConstantPoolGen var2) {
        if (var1 != -1) {
            ...
            if ((var3 = var2.getConstant(var1)) != null) {
                ...
                int var5;
                for (int var10000 = var5 = var1 + 1; var10000 < var4 && var2.getConstant(var5) == null; var10000 = var5) {
    ...
    private void method1261(ElementValueGen var1, ConstantPoolGen var2) {
        if (var1 instanceof AnnotationElementValueGen) {
            ...
            List var4 = ((ArrayElementValueGen) var1).getElementValues();
    ...
    private void method1262(ElementValueGen var1) {
        if (var1 instanceof AnnotationElementValueGen) {
            ...
            if (var1 instanceof ArrayElementValueGen) {
                ArrayElementValueGen var2;
                List var3;
                for (int var10000 = var4 = (var3 = (var2 = (ArrayElementValueGen) var1).getElementValues()).size() - 1; var10000 >= 0; var10000 = var4) {
    ...
    private void method1263(AnnotationEntryGen var1, ConstantPoolGen var2) {
        ...
        for (int var10000 = var4 = (var3 = var1.getValues()).size() - 1; var10000 >= 0; var10000 = var4) {
            ElementValuePairGen var5 = (ElementValuePairGen) var3.get(var4);
    ...
    private void method1264(MethodGen var1) {
        ...
        if ((var2 = var1.getInstructionList()) != null) {
            ...
            int var4;
            for (int var10000 = var4 = (var3 = var2.getInstructionHandles()).length - 1; var10000 >= 0; var10000 = var4) {
                Instruction var6 = var3[var4].getInstruction();
                if (var6 instanceof CPInstruction) {
                    CPInstruction var7 = (CPInstruction) var6;
