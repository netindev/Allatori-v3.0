...
public class StringObfuscationLayer1 implements ObfuscationType {
    ...
    private static final char aChar1148 = 'U';
    ...
    private Collection aCollection1152 = new TreeSet();
    private ClassStorage aClassStorage_1153;
    private static String decryptString2MethodName = "DecryptString2";


    private void createStrongDecrypt1Method(ClassGen var1) {
        InstructionFactory var2 = new InstructionFactory(var1);
        ConstantPoolGen constantPoolGen = var1.getConstantPool();
        InstructionList instructionList = new InstructionList();
        MethodGen var6 = new MethodGen(9, Type.STRING, new Type[]{Type.STRING}, new String[]{"s"}, decryptStringMethodName, var1.getClassName(), instructionList, constantPoolGen);
        instructionList.append(var2.createNew("java.lang.String"));
        instructionList.append(InstructionConstants.DUP);
        instructionList.append(InstructionFactory.createLoad(Type.OBJECT, 0));
        instructionList.append(var2.createInvoke("java.lang.String", "length", Type.INT, Type.NO_ARGS, (short) 182));
        instructionList.append(var2.createNewArray(Type.CHAR, (short) 1));
        ...
        BranchInstruction var7 = InstructionFactory.createBranchInstruction((short) 155, null);
        BranchHandle var8 = instructionList.append(var7);
        ...
        instructionList.append(InstructionFactory.createLoad(Type.OBJECT, 0));
        instructionList.append(InstructionFactory.createLoad(Type.INT, 3));
        instructionList.append(var2.createInvoke("java.lang.String", "charAt", Type.CHAR, new Type[]{Type.INT}, (short) 182));
        ...
        instructionList.append(InstructionFactory.createLoad(Type.INT, 3));
        BranchInstruction var9 = InstructionFactory.createBranchInstruction((short) 155, null);
        instructionList.append(var9);
        instructionList.append(InstructionFactory.createLoad(Type.OBJECT, 1));
        instructionList.append(InstructionFactory.createLoad(Type.INT, 3));
        instructionList.append(InstructionFactory.createLoad(Type.OBJECT, 0));
        instructionList.append(InstructionFactory.createLoad(Type.INT, 3));
        ...
        instructionList.append(new IINC(3, -1));
        instructionList.append(InstructionFactory.createLoad(Type.INT, 3));
        instructionList.append(InstructionFactory.createBranchInstruction((short) 167, var8));
        InstructionHandle var10 = instructionList.append(InstructionFactory.createLoad(Type.OBJECT, 1));
        instructionList.append(var2.createInvoke("java.lang.String", "<init>", Type.VOID, new Type[]{new ArrayType(Type.CHAR, 1)}, (short) 183));
        instructionList.append(InstructionFactory.createReturn(Type.OBJECT));
        var7.setTarget(var10);
    ...
    private void createWeakDecryptMethod(ClassGen var1) {
        InstructionFactory var2 = new InstructionFactory(var1);
        ConstantPoolGen var4 = var1.getConstantPool();
        InstructionList var5 = new InstructionList();
        MethodGen var6 = new MethodGen(9, Type.STRING, new Type[]{Type.STRING}, new String[]{"s"}, decryptStringMethodName, var1.getClassName(), var5, var4);
        int var7 = var4.addClass("java.lang.String");
        int var8 = var4.addClass("[C");
        int var9 = var4.addUtf8("StackMap");
        ConstantPool var10 = var4.getConstantPool();
        StackMapEntry var11 = new StackMapEntry(27, 4, new StackMapType[]{new StackMapType((byte) 7, var7, var10), new StackMapType((byte) 7, var8, var10), new StackMapType((byte) 1, 0, var10), new StackMapType((byte) 1, 0, var10)}, 0, new StackMapType[0], var10);
        StackMapEntry var12 = new StackMapEntry(58, 4, new StackMapType[]{new StackMapType((byte) 7, var7, var10), new StackMapType((byte) 7, var8, var10), new StackMapType((byte) 1, 0, var10), new StackMapType((byte) 1, 0, var10)}, 0, new StackMapType[0], var10);
        StackMap var13 = new StackMap(var9, 30, new StackMapEntry[]{var11, var12}, var10);
        ...
        BranchInstruction var14 = InstructionFactory.createBranchInstruction((short) 167, null);
        var5.append(var14);
        InstructionHandle var15 = var5.append(InstructionFactory.createLoad(Type.OBJECT, 1));
        ...
        InstructionHandle var16 = var5.append(InstructionFactory.createLoad(Type.INT, 3));
        BranchInstruction var17 = InstructionFactory.createBranchInstruction((short) 156, var15);
        var5.append(var17);
        var5.append(var2.createNew("java.lang.String"));
        var5.append(InstructionConstants.DUP);
        var5.append(InstructionFactory.createLoad(Type.OBJECT, 1));
        var5.append(var2.createInvoke("java.lang.String", "<init>", Type.VOID, new Type[]{new ArrayType(Type.CHAR, 1)}, (short) 183));
    ...
    public static String encryptHard(String string, String variableXor) {
        int var2 = variableXor.length() - 1;
        int var3 = variableXor.length() - 1;
        char[] var4 = new char[string.length()];
        char opcode = 85;
    ...
    public void terminate() {
        if (this.aBoolean1149) {
            this.aClassStorage_1153.addClass(this.createDecryptionClass());
        }

    }

    public void execute(ClassGen _cg) {
        if (Tuning.method1726(this.aClassStorage_1153, _cg, null) != Tuning.STRING_ENCRYPTION_DISABLE) {
            InstructionFactory var2 = new InstructionFactory(_cg);
            ...
            for (int var10000 = var4 = 0; var10000 < methods.length; var10000 = var4) {
                ...
                if ((method = methods[var4]).getCode() != null) {
                    ...
                    for (InstructionHandle var14 = var8 = (il = (_mgen = InitUtils.createMethodGen(method, _cg.getClassName(), _cg.getConstantPool(), _cg.getConstantPool().getConstantPool())).getInstructionList()).getStart(); var14 != null; var14 = var8) {
                        if (var8.getInstruction() instanceof LDC_W) {
                            LDC_W var9 = (LDC_W) var8.getInstruction();
                            Constant var10;
                            if ((var10 = _cg.getConstantPool().getConstant(var9.getIndex())) instanceof ConstantString) {
                                String var11 = ((ConstantUtf8) _cg.getConstantPool().getConstant(((ConstantString) var10).getStringIndex())).getBytes();
                                if (this.aClassStorage_1153.getClassGen(var11) != null || this.aCollection1152.contains(var11)) {
                                    var8 = var8.getNext();
                                    continue;
                                }

                                int var12 = Tuning.method1716(this.aClassStorage_1153, _cg, _mgen);
                                String var13;
                                ...
                                if (var12 == Tuning.STRING_ENCRYPTION_STRONG_TYPE) {
                                    var9.setIndex(_cg.getConstantPool().addString(aString1150 + var11));
                                    il.append(var8, var2.createInvoke(string_decryptor_class_name, decryptString2MethodName, Type.STRING, new Type[]{Type.STRING}, (short) 184));
                                } else {
                                    var9.setIndex(_cg.getConstantPool().addString(this.encryptWeak(var11)));
                                    il.append(var8, var2.createInvoke(string_decryptor_class_name, decryptStringMethodName, Type.STRING, new Type[]{Type.STRING}, (short) 184));
                                }
    ...
    private void method1366(ClassGen var1) {
        ...
        for (var10000 = var3 = (var2 = var1.getFields()).length - 1; var10000 >= 0; var10000 = var3) {
            ConstantValue var5;
            Constant var6;
            if ((var5 = var2[var3].getConstantValue()) != null && (var6 = var1.getConstantPool().getConstant(var5.getConstantValueIndex())) instanceof ConstantString) {
                String var7 = ((ConstantUtf8) var1.getConstantPool().getConstant(((ConstantString) var6).getStringIndex())).getBytes();
                this.aCollection1152.add(var7);
            }
        ...
        for (var10000 = var15 = (var4 = var1.getMethods()).length - 1; var10000 >= 0; var10000 = var15) {
            ...
            if ((var16 = var4[var15]).getCode() != null) {
                InstructionHandle var9 = InitUtils.createMethodGen(var16, var1.getClassName(), var1.getConstantPool(), var1.getConstantPool().getConstantPool()).getInstructionList().getStart();

                for (InstructionHandle var14 = var9; var14 != null; var14 = var9) {
                    if ((var9.getInstruction() instanceof PUTSTATIC || var9.getInstruction() instanceof PUTFIELD) && var9.getPrev() != null) {
                        InstructionHandle var10 = var9.getPrev();
                        if (var10.getInstruction() instanceof LDC_W) {
                            LDC_W var11 = (LDC_W) var10.getInstruction();
                            Constant var12 = var1.getConstantPool().getConstant(var11.getIndex());
                            if (var12 instanceof ConstantString) {
                                String var13 = ((ConstantUtf8) var1.getConstantPool().getConstant(((ConstantString) var12).getStringIndex())).getBytes();
                                this.aCollection1152.add(var13);
                            }
                        }
                    }
    ...
    private void method1367(ClassGen var1) {
        ...
        for (int var10000 = var3 = (var2 = var1.getFields()).length - 1; var10000 >= 0; var10000 = var3) {
            ...
            ConstantValue var5;
            Constant var6;
            if ((var5 = (var4 = var2[var3]).getConstantValue()) != null && (var6 = var1.getConstantPool().getConstant(var5.getConstantValueIndex())) instanceof ConstantString && var4.isFinal()) {
                if (!var4.isStatic()) {
                    FieldGen var15;
                    ...
                    MethodGen var16;
                    if (clinit != null) {
                        var11 = (var16 = InitUtils.createMethodGen(clinit, var1.getClassName(), var1.getConstantPool(), var1.getConstantPool().getConstantPool())).getInstructionList();
                    } else {
                        var16 = new MethodGen(8, Type.VOID, Type.NO_ARGS, new String[0], "<clinit>", var1.getClassName(), var11, var1.getConstantPool());
                    }

                    String var12 = ((ConstantUtf8) var1.getConstantPool().getConstant(((ConstantString) var6).getStringIndex())).getBytes();
                    InstructionFactory var13 = new InstructionFactory(var1);
                    var11.insert(var13.createFieldAccess(var1.getClassName(), var4.getName(), Type.STRING, (short) 179));
    ...
    private ClassGen createDecryptionClass() {
        ClassGen var1 = new ClassGen(string_decryptor_class_name, "java.lang.Object", "", 33, new String[0]);
    ...
    private void createStrongDecrypt2Method(ClassGen var1) {
        InstructionFactory var2 = new InstructionFactory(var1);
        ConstantPoolGen cp = var1.getConstantPool();
        InstructionList il = new InstructionList();
        MethodGen var6 = new MethodGen(9, Type.STRING, new Type[]{Type.STRING}, new String[]{"arg0"}, decryptString2MethodName, var1.getClassName(), il, cp);
        ...
        il.append(var2.createInvoke("java.lang.Exception", "getStackTrace", new ArrayType(new ObjectType("java.lang.StackTraceElement"), 1), Type.NO_ARGS, (short) 182));
        ...
        il.append(InstructionConstants.SWAP);
        il.append(InstructionConstants.DUP);
        il.append(var2.createInvoke("java.lang.StackTraceElement", "getClassName", Type.STRING, Type.NO_ARGS, (short) 182));
        il.append(InstructionConstants.SWAP);
        il.append(var2.createInvoke("java.lang.StackTraceElement", "getMethodName", Type.STRING, Type.NO_ARGS, (short) 182));
        il.append(InstructionConstants.DUP_X2);
        il.append(InstructionConstants.POP);
        il.append(var2.createInvoke("java.lang.StringBuffer", "append", Type.STRINGBUFFER, new Type[]{Type.STRING}, (short) 182));
        il.append(InstructionConstants.SWAP);
        il.append(var2.createInvoke("java.lang.StringBuffer", "append", Type.STRINGBUFFER, new Type[]{Type.STRING}, (short) 182));
        ...
        BranchInstruction var7 = InstructionFactory.createBranchInstruction((short) 167, null);
        il.append(var7);
        InstructionHandle var8 = il.append(new PUSH(cp, 63));
        il.append(InstructionConstants.DUP_X2);
        il.append(InstructionConstants.POP);
        il.append(InstructionConstants.DUP_X1);
        il.append(InstructionConstants.POP);
        ...
        il.append(InstructionFactory.createLoad(Type.INT, 4));
        BranchInstruction var9 = InstructionFactory.createBranchInstruction((short) 156, null);
        il.append(var9);
        il.append(InstructionFactory.createLoad(Type.INT, 3));
        il.append(InstructionFactory.createStore(Type.INT, 4));
        InstructionHandle var10 = il.append(new IINC(7, -1));
        InstructionHandle var11 = il.append(InstructionFactory.createLoad(Type.OBJECT, 5));
        il.append(InstructionFactory.createLoad(Type.INT, 7));
        il.append(InstructionConstants.DUP);
        BranchInstruction var12 = InstructionFactory.createBranchInstruction((short) 156, var8);
        il.append(var12);
        ...
        il.append(InstructionConstants.DUP_X1);
        il.append(InstructionConstants.SWAP);
        il.append(var2.createInvoke("java.lang.String", "<init>", Type.VOID, new Type[]{new ArrayType(Type.CHAR, 1)}, (short) 183));
