...
public class Renamer {
    ...
    private ClassStorage aClassStorage_504;
    ...
    private Class56 aClass56_508;
    private Class172 aClass172_509 = new Class172(this, (Class178) null);
    private Class26 aClass26_510 = new Class26();
    ...
    private void method296(ElementValueGen var1, ConstantPoolGen var2) {
        if (var1 instanceof AnnotationElementValueGen) {
            ...
            if (var1 instanceof ArrayElementValueGen) {
                ArrayElementValueGen var3;
                List var4;
                for (int var10000 = var5 = (var4 = (var3 = (ArrayElementValueGen) var1).getElementValues()).size() - 1; var10000 >= 0; var10000 = var5) {
                ...
                if (var1 instanceof EnumElementValueGen) {
                    ...
                    String var10 = (var9 = (EnumElementValueGen) var1).getEnumTypeString();
                    String var11 = null;
                    String var6;
                    String var7;
                    ...
                    if (var11 != null) {
                        ...
                        if (Class159.method1626(Class172.method1710(this.aClass172_509)).containsKey(var7)) {
                            String var8 = Class159.method1626(Class172.method1710(this.aClass172_509)).get(var7);
    ...
    private void method297() {
        ...
        for (Iterator var10000 = var1 = this.aClass56_508.method703().iterator(); var10000.hasNext(); var10000 = var1) {
            ...
            ConstantPoolGen var3 = var2.getConstantPool();
    ...
    private void method298(ClassGen var1) {
        ...
        for (var10000 = var4 = (var3 = var1.getMethods()).length - 1; var10000 >= 0; var10000 = var4) {
            ...
            if (this.method307(var2, var5) || !Class28.method507(this.aClassStorage_504, var1, var5)) {
                var6 = var5.getName();
                String var7 = var5.getSignature();
                if (!NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)).containsKey(var2 + "&" + var6 + "&" + var7)) {
                    NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)).put(var2 + "&" + var6 + "&" + var7, var6);
                    NameRepository.getMethodRenamingMap(Class172.method1707(this.aClass172_509)).put(var2 + "&" + var6 + "&" + MethodUtils.method1454(var7), "&");
                    if (!var5.isPrivate()) {
                        this.method319(var1, var6, var6, var7, var1.isInterface(), MethodUtils.method1450(var5));
                    }
                } else if (!var5.isPrivate()) {
                    this.method319(var1, var6, NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)).get(var2 + "&" + var6 + "&" + var7), var7, var1.isInterface(), MethodUtils.method1450(var5));
                }
            }
        ...
        do {
            ...
            if ((var12 = this.aClassStorage_504.getClassGen(var6)) != null) {
                ...
                for (var10000 = var8 = (var13 = var12.getMethods()).length - 1; var10000 >= 0; var10000 = var8) {
                    Method var9 = var13[var8];
                    if (!this.method307(var6, var9) && !Class28.method507(this.aClassStorage_504, var1, var9)) {
                        String var10 = var9.getName();
                        String var11 = var9.getSignature();
                        if (!NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)).containsKey(var6 + "&" + var10 + "&" + var11)) {
                            NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)).put(var6 + "&" + var10 + "&" + var11, var10);
                            NameRepository.getMethodRenamingMap(Class172.method1707(this.aClass172_509)).put(var6 + "&" + var10 + "&" + MethodUtils.method1454(var11), "&");
                            if (!var9.isPrivate()) {
                                this.method319(var12, var10, var10, var11, var12.isInterface(), MethodUtils.method1450(var9));
                            }
                        } else if (!var9.isPrivate()) {
                            this.method319(var12, var10, NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)).get(var6 + "&" + var10 + "&" + var11), var11, var12.isInterface(), MethodUtils.method1450(var9));
                        }
                    }
    ...
    private void renameFields(ClassGen var1) {
        ...
        for (int var10000 = var3 = (var2 = var1.getFields()).length - 1; var10000 >= 0; var10000 = var3) {
            ...
            String var5 = Class159.method1626(Class172.method1710(this.aClass172_509)).get(var1.getClassName() + "&" + var4.getName() + "&" + var4.getSignature());
            Type var6 = MethodUtils.method1449(var4.getType(), Class165.method1653(Class172.method1708(this.aClass172_509)));
            boolean var7 = false;
            if ((Class165.method1652(Class172.method1708(this.aClass172_509)).containsKey(var1.getClassName()) || Packaging.method575()) && !var4.isPrivate()) {
                var7 = true;
            }

            if (!var5.equals(var4.getName()) || var6 != null || var7 || var4.getAnnotationEntries().length > 0) {
                FieldGen var8 = new FieldGen(var4, var1.getConstantPool());
                ...
                if (var6 != null) {
                    var8.setType(var6);
                    Class159.method1628(Class172.method1710(this.aClass172_509)).put(var4.getSignature(), var8.getSignature());
                }
    ...
    private void renamePackage(ClassGen var1) {
        ...
        if (!Class165.method1653(Class172.method1708(this.aClass172_509)).containsKey(var2)) {
            String var3 = MethodUtils.getPackageName(var2);
    ...
    private void renameClassName(ClassGen var1) {
        ...
        for (var10000 = var4 = (var3 = var1.getFields()).length - 1; var10000 >= 0; var10000 = var4) {
            ...
            if (!Class28.method504(this.aClassStorage_504, var1, var5)) {
                var6 = var5.getName();
                String var7 = var5.getSignature();
                if (!Class159.method1626(Class172.method1710(this.aClass172_509)).containsKey(var2 + "&" + var6 + "&" + var7)) {
                    Class159.method1626(Class172.method1710(this.aClass172_509)).put(var2 + "&" + var6 + "&" + var7, var6);
                    Class159.method1625(Class172.method1710(this.aClass172_509)).put(var2 + "&" + var6 + "&" + var7, "&");
                    if (!var5.isPrivate()) {
                        this.method306(var1, var6, var6, var7);
                    }
                } else if (!var5.isPrivate()) {
                    this.method306(var1, var6, Class159.method1626(Class172.method1710(this.aClass172_509)).get(var2 + "&" + var6 + "&" + var7), var7);
                }
            }
        ...
        do {
            ...
            if ((var12 = this.aClassStorage_504.getClassGen(var6)) != null) {
                ...
                for (var10000 = var8 = (var13 = var12.getFields()).length - 1; var10000 >= 0; var10000 = var8) {
                    Field var9 = var13[var8];
                    if (!Class28.method504(this.aClassStorage_504, var1, var9)) {
                        String var10 = var9.getName();
                        String var11 = var9.getSignature();
                        if (!Class159.method1626(Class172.method1710(this.aClass172_509)).containsKey(var6 + "&" + var10 + "&" + var11)) {
                            Class159.method1626(Class172.method1710(this.aClass172_509)).put(var6 + "&" + var10 + "&" + var11, var10);
                            Class159.method1625(Class172.method1710(this.aClass172_509)).put(var6 + "&" + var10 + "&" + var11, "&");
                            if (!var9.isPrivate()) {
                                this.method306(var12, var10, var10, var11);
                            }
                        } else if (!var9.isPrivate()) {
                            this.method306(var12, var10, Class159.method1626(Class172.method1710(this.aClass172_509)).get(var6 + "&" + var10 + "&" + var11), var11);
                        }
                    }
    ...
    private String method305(String var1) {
        ...
        for (int var10000 = var2 = var1.length() - 1; var10000 >= 0; var10000 = var2) {
            if (var1.charAt(var2) == 76) {
                ...
                if (var3 > var2) {
                    String var5 = var1.substring(var2 + 1, var3).replace('/', '.');
                    String var6;
                    if ((var6 = Class165.method1653(Class172.method1708(this.aClass172_509)).get(var5)) != null) {
                        var1 = var1.substring(0, var2 + 1) + var6.replace('.', '/') + var1.substring(var2 + var5.length() + 1);
                    }
                }
            }
    ...
    private void method306(ClassGen var1, String var2, String var3, String var4) {
        Vector var5;
        int var6;
        for (int var10000 = var6 = (var5 = this.aClass56_508.method691(var1.getClassName())).size() - 1; var10000 >= 0; var10000 = var6) {
            ClassGen var7 = (ClassGen) var5.get(var6);
            Class159.method1626(Class172.method1710(this.aClass172_509)).put(var7.getClassName() + "&" + var2 + "&" + var4, var3);
            Class159.method1625(Class172.method1710(this.aClass172_509)).put(var7.getClassName() + "&" + var3 + "&" + var4, "&");
    ...
    private boolean method307(String var1, Method var2) {
        return !var2.isNative() && !this.aClass56_508.method694(var1, var2.getName(), var2.getSignature()) ? "<init>".equals(var2.getName()) || "<clinit>".equals(var2.getName()) || "main".equals(var2.getName()) && "([Ljava/lang/String;)V".equals(var2.getSignature()) : true;
    }
    ...
    private void unrenamePackage(ClassGen var1) {
        if (this.method328(var1) || !Class28.method509(this.aClassStorage_504, var1)) {
            String var2 = var1.getClassName();
            boolean var3 = false;
            if (Class165.method1653(Class172.method1708(this.aClass172_509)).containsKey(var2) && !var2.equals(Class165.method1653(Class172.method1708(this.aClass172_509)).get(var2))) {
                var3 = true;
            }
            ...
            if (!var3) {
                ...
                if (Packaging.method579() && (var5 = Class141.method1520(Class172.method1711(this.aClass172_509)).get(var4)) != null && !var5.equals(var4)) {
                ...
                var4 = MethodUtils.getPackageName(var2);
                var5 = MethodUtils.getPackageName(Class165.method1653(Class172.method1708(this.aClass172_509)).get(var2));
                if (!Packaging.method578() || !var5.equals(Packaging.method576())) {
                    if ((new StringTokenizer(var4, ".")).countTokens() == (new StringTokenizer(var5, ".")).countTokens()) {
    ...
    private void method312(Attribute[] var1, ConstantPoolGen var2) {
        ...
        for (int var10000 = var3 = var1.length - 1; var10000 >= 0; var10000 = var3) {
            ...
            } else if (!(var4 instanceof ConstantValue) && !(var4 instanceof Deprecated) && !(var4 instanceof ExceptionTable) && !(var4 instanceof InnerClasses) && !(var4 instanceof LineNumberTable) && !(var4 instanceof LocalVariableTable) && !(var4 instanceof PMGClass)) {
                String var7;
                if (var4 instanceof Signature) {
                    Signature var15;
                    String var6 = (var15 = (Signature) var4).getSignature();
                    var7 = this.method305(var6);
                    var15.setSignatureIndex(var2.addUtf8(var7));
                } else if (!(var4 instanceof SourceFile) && !(var4 instanceof StackMap) && !(var4 instanceof Synthetic)) {
                    if (var4 instanceof EnclosingMethod) {
                        EnclosingMethod var16;
                        if ((var16 = (EnclosingMethod) var4).getEnclosingMethodIndex() != 0) {
                            ConstantPool var17 = var2.getConstantPool();
                            ...
                            if ((var9 = var16.getEnclosingMethod()) != null) {
                                String var10 = var9.getName(var17);
                                String var11 = var9.getSignature(var17);
                                String var12 = NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)).get(var7 + "&" + var10 + "&" + var11);
                                String var13 = NameRepository.method1534(Class172.method1707(this.aClass172_509)).get(var11);
                                if (var12 != null && !var12.equals(var10) || var13 != null) {
                                    ...
                                    int var14 = var2.addNameAndType(var12, var13);
    ...
    private void renameMethods(ClassGen var1) {
        ...
        for (int var10000 = var3 = (var2 = var1.getMethods()).length - 1; var10000 >= 0; var10000 = var3) {
            Method var4;
            MethodGen var5 = InitUtils.createMethodGen(var4 = var2[var3], var1.getClassName(), var1.getConstantPool(), var1.getConstantPool().getConstantPool());
            this.method321(var1, var5);
            String var6 = NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)).get(var1.getClassName() + "&" + var4.getName() + "&" + var4.getSignature());
            var5.setName(var6);
            boolean var7 = false;
            ...
            for (var10000 = var9 = (var8 = var5.getArgumentTypes()).length - 1; var10000 >= 0; var10000 = var9) {
                if ((var10 = MethodUtils.method1449(var8[var9], Class165.method1653(Class172.method1708(this.aClass172_509)))) != null) {
            ...
            if ((var10 = MethodUtils.method1449(var5.getReturnType(), Class165.method1653(Class172.method1708(this.aClass172_509)))) != null) {
                var5.setReturnType(var10);
                var7 = true;
            }

            if (var7) {
                NameRepository.method1534(Class172.method1707(this.aClass172_509)).put(var4.getSignature(), var5.getSignature());
            }
    ...
    private void renameConstantPoolConstants(ClassGen var1) {
        ...
        for (var10000 = var3 = (var2 = var1.getConstantPool()).getSize() - 1; var10000 >= 0; var10000 = var3) {
            ...
            if (!((var4 = var2.getConstant(var3)) instanceof ConstantClass)) {
                if (var4 instanceof ConstantCP) {
                    ConstantPool var5 = var2.getConstantPool();
                    ConstantCP var6;
                    ...
                    ConstantNameAndType var9;
                    String var10 = (var9 = (ConstantNameAndType) var2.getConstant(var6.getNameAndTypeIndex())).getName(var5);
                    ...
                    if (!(var6 instanceof ConstantMethodref) && !(var6 instanceof ConstantInterfaceMethodref)) {
                        if (var6 instanceof ConstantFieldref) {
                            var12 = Class159.method1626(Class172.method1710(this.aClass172_509)).get(var7 + "&" + var10 + "&" + var11);
                            var13 = Class159.method1628(Class172.method1710(this.aClass172_509)).get(var11);
                        }
                    } else {
                        var12 = NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)).get(var7 + "&" + var10 + "&" + var11);
        ...
        for (var10000 = var15 = var2.getSize() - 1; var10000 >= 0; var10000 = var15) {
            ...
            if ((var16 = var2.getConstant(var15)) instanceof ConstantClass) {
                ConstantPool var18 = var2.getConstantPool();
                ConstantClass var19;
                ...
                if ((var8 = Class165.method1653(Class172.method1708(this.aClass172_509)).get(var7)) != null) {
                    ...
                    {
                        int var21;
                        for (var10000 = var21 = 0; var10000 < var7.length() && var7.charAt(var21) == 91; var10000 = var21) {
                            ++var21;
                        }
    ...
    public Renamer(ClassStorage var1) {
        ...
        if (Packaging.method579()) {
            try {
                DefaultHandler_Sub2.method1851(new DefaultHandler_Sub2(this, null));
    ...
    private String method316(ClassGen var1, String var2, String var3) {
        String var4;
        if ((var4 = NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)).get(var1.getClassName() + "&" + var2 + "&" + var3)) != null) {
            return var4;
        } else {
            Vector var5;
            int var6;
    ...
    private boolean method317(ClassGen var1, String var2, String var3, boolean var4) {
        if (NameRepository.getMethodRenamingMap(Class172.method1707(this.aClass172_509)).containsKey(var1.getClassName() + "&" + var2 + "&" + var3)) {
            return true;
        } else if (!var4) {
            return false;
        } else {
            ...
            int var6;
            for (int var10000 = var6 = (var5 = this.aClass56_508.method691(var1.getClassName())).size() - 1; var10000 >= 0; var10000 = var6) {
                if (this.method317((ClassGen) var5.get(var6), var2, var3, var4)) {
                    return true;
                }
    ...
    private void method319(ClassGen var1, String var2, String var3, String var4, boolean var5, boolean var6) {
        if (var5) {
            ...
            do {
                String var8 = var7.getSuperclassName();
                if ((var7 = this.aClassStorage_504.getClassGen(var8)) != null) {
                    NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)).put(var7.getClassName() + "&" + var2 + "&" + var4, var3);
                    if (var7.isAnnotation()) {
                        NameRepository.getSignatureNamingMap(Class172.method1707(this.aClass172_509)).put(var7.getClassName() + "&" + var2, var3);
                    }

                    NameRepository.getMethodRenamingMap(Class172.method1707(this.aClass172_509)).put(var7.getClassName() + "&" + var3 + "&" + MethodUtils.method1454(var4), "&");
                }
            } while (var7 != null);
        }
        ...
        Vector var10;
        int var11;
        for (int var10000 = var11 = (var10 = this.aClass56_508.method691(var1.getClassName())).size() - 1; var10000 >= 0; var10000 = var11) {
            ClassGen var9 = (ClassGen) var10.get(var11);
            if (var6 && Packaging.method578() && !MethodUtils.getPackageName(var1.getClassName()).equals(MethodUtils.getPackageName(var9.getClassName()))) {
                NameRepository.getMethodRenamingMap(Class172.method1707(this.aClass172_509)).put(var9.getClassName() + "&" + var3 + "&" + MethodUtils.method1454(var4), "&");
            } else {
                NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)).put(var9.getClassName() + "&" + var2 + "&" + var4, var3);
                if (var9.isAnnotation()) {
                    NameRepository.getSignatureNamingMap(Class172.method1707(this.aClass172_509)).put(var9.getClassName() + "&" + var2, var3);
                }
    ...
    private void method321(ClassGen var1, MethodGen var2) {
        ...
        if ((var3 = LocalVariables.method369(this.aClassStorage_504, var1, var2)) == 4) {
            ...
            boolean var4 = var3 == 3;
            LocalVariableGen[] var5 = var2.getLocalVariables();
            ...
            for (int var10000 = var7 = var5.length - 1; var10000 >= 0; var10000 = var7) {
                ...
                Type var9;
                if ((var9 = MethodUtils.method1449((var8 = var5[var7]).getType(), Class165.method1653(Class172.method1708(this.aClass172_509)))) != null) {
                    var8.setType(var9);
                }
    ...
    private boolean method322(ClassGen var1, String var2, String var3, boolean var4, boolean var5) {
        if (var5) {
            ...
            do {
                String var7 = var6.getSuperclassName();
                if ((var6 = this.aClassStorage_504.getClassGen(var7)) != null && NameRepository.getMethodRenamingMap(Class172.method1707(this.aClass172_509)).containsKey(var6.getClassName() + "&" + var2 + "&" + var3)) {
                    return true;
                }
            } while (var6 != null);
        }
        ...
        if (NameRepository.getMethodRenamingMap(Class172.method1707(this.aClass172_509)).containsKey(var1.getClassName() + "&" + var2 + "&" + var3)) {
            ...
            Vector var8;
            int var9;
            for (int var10000 = var9 = (var8 = this.aClass56_508.method691(var1.getClassName())).size() - 1; var10000 >= 0; var10000 = var9) {
    ...
    private void method323(ClassGen var1) {
        ...
        for (int var10000 = var4 = (var3 = var1.getMethods()).length - 1; var10000 >= 0; var10000 = var4) {
            Method var5;
            String var6 = (var5 = var3[var4]).getName();
            String var7 = var5.getSignature();
            String var8;
            if (!var5.isPrivate()) {
                var8 = this.method316(var1, var6, var7);
            } else {
                var8 = NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)).get(var2 + "&" + var6 + "&" + var7);
            }
            ...
            if (var8 == null) {
                ...
                while (this.method322(var1, var8, MethodUtils.method1454(var7), !var5.isPrivate(), var1.isInterface()));
            }

            NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)).put(var2 + "&" + var6 + "&" + var7, var8);
            if (var1.isAnnotation()) {
                NameRepository.getSignatureNamingMap(Class172.method1707(this.aClass172_509)).put(var2 + "&" + var6, var8);
            }

            NameRepository.getMethodRenamingMap(Class172.method1707(this.aClass172_509)).put(var2 + "&" + var8 + "&" + MethodUtils.method1454(var7), "&");
            if (!var5.isPrivate()) {
    ...
    public void run() throws Exception_Sub2 {
        ...
        this.method308();
        this.method297();
        LogFile.setObfuscationHandler(new Class5(Class165.method1653(Class172.method1708(this.aClass172_509)), NameRepository.getConstantNamingMap(Class172.method1707(this.aClass172_509)), Class159.method1626(Class172.method1710(this.aClass172_509)), this.aClass26_510.method496(), this.aClass26_510.method497(), NameRepository.getSignatureNamingMap(Class172.method1707(this.aClass172_509))));
    }

    private boolean method326(ClassGen var1, String var2, String var3, boolean var4) {
        if (Class159.method1625(Class172.method1710(this.aClass172_509)).containsKey(var1.getClassName() + "&" + var2 + "&" + var3)) {
            return true;
        } else if (!var4) {
            return false;
        } else {
    ...
    private void method327(ClassGen var1) {
        ...
        for (int var10000 = var4 = var3.length - 1; var10000 >= 0; var10000 = var4) {
            ...
            String var7 = var5.getSignature();
            String var8;
            if ((var8 = Class159.method1626(Class172.method1710(this.aClass172_509)).get(var2 + "&" + var6 + "&" + var7)) == null) {
    ...
    private void renameSignatures(AnnotationEntryGen var1, ConstantPoolGen var2) {
        String var3 = var1.getTypeSignature();
        String var4 = null;
        ...
        for (int var10000 = var12 = (var11 = var1.getValues()).size() - 1; var10000 >= 0; var10000 = var12) {
            ElementValuePairGen var7 = (ElementValuePairGen) var11.get(var12);
            if (var4 != null) {
                String var8 = var7.getNameString();
                String var9 = var4 + "&" + var8;
                if (NameRepository.getSignatureNamingMap(Class172.method1707(this.aClass172_509)).containsKey(var9)) {
                    String var10 = NameRepository.getSignatureNamingMap(Class172.method1707(this.aClass172_509)).get(var9);
    ...
    private void method330(ClassGen var1) {
        if (Class165.method1652(Class172.method1708(this.aClass172_509)).containsKey(var1.getClassName()) || Packaging.method575()) {
            MethodUtils.method1448(var1);
        }

        if (Tuning.isFinalizingEnabled() && !var1.isAbstract() && !var1.isInterface() && !var1.isAnnotation() && !var1.isEnum() && this.aClass56_508.method691(var1.getClassName()).isEmpty()) {
            var1.isFinal(true);
        }

        String var2 = Class165.method1653(Class172.method1708(this.aClass172_509)).get(var1.getClassName());
