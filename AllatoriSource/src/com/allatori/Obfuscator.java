...
public class Obfuscator {
	...
	private void method1525() {
		...
		Iterator<?> var2;
		for (Iterator<?> var10000 = var2 = this.classes.iterator(); var10000.hasNext(); var10000 = var2) {
	...
	public void method1526() {
		Iterator<?> var1;
		Iterator<?> var10000;
		for (var10000 = var1 = this.classes.iterator(); var10000.hasNext(); var10000 = var1) {
		...
		if (Tuning.isStringObfuscationLayer2Enabled()) {
			...
			Iterator<?> var3;
			for (var10000 = var3 = this.classes.iterator(); var10000.hasNext(); var10000 = var3) {
