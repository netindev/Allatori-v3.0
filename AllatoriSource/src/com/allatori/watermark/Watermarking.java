...
public class Watermarking {
    ...
    private String aString891;
    private ClassStorage aClassStorage_892;


    public String extractWatermark() throws Exception_Sub1 {
        try {
            Vector var1 = this.method1761();
            short[] var2 = this.method1759(var1);
    ...
    private short[] method1759(Vector var1) {
        ...
        for (var10000 = var3 = var1.size() - 1; var10000 >= 0; var10000 = var3) {
            ...
            for (InstructionHandle var7 = var6 = Class171.method1704((Class171) var1.get(var3)).getInstructionList().getStart(); var7 != null; var7 = var6 = var6.getNext()) {
    ...
    private void method1760(Vector var1, short[] var2) {
        ...
        while (var10000 >= 0) {
            ...
            int var10;
            if ((var10 = (var9 = Class171.method1704(var8 = (Class171) var1.get(var7)).getInstructionList()).getLength()) > 0) {
            ...
            while (true) {
                ...
                if (var10000 <= 0) {
                    ...
                    Class171.method1705(var8).replaceMethod(Class171.method1706(var8), Class171.method1704(var8).getMethod());
                    --var7;
                    var10000 = var7;
                    break;
                }
    ...
    private Vector method1761() {
        ...
        for (Iterator var10000 = var2 = this.aClassStorage_892.method671(); var10000.hasNext(); var10000 = var2) {
            ClassGen var3;
            Method[] var4;
            for (int var7 = var5 = (var4 = (var3 = (ClassGen) var2.next()).getMethods()).length - 1; var7 >= 0; var7 = var5) {
                Method var6;
    ...
    private boolean method1762(InstructionHandle var1) {
        return var1.getInstruction() instanceof SIPUSH && var1.getNext() != null && var1.getNext().getInstruction() instanceof SIPUSH && var1.getNext().getNext() != null && var1.getNext().getNext().getInstruction() instanceof SIPUSH && var1.getNext().getNext().getNext() != null && var1.getNext().getNext().getNext().getInstruction() instanceof SIPUSH && var1.getNext().getNext().getNext().getNext() != null && var1.getNext().getNext().getNext().getNext().getInstruction() instanceof POP2 && var1.getNext().getNext().getNext().getNext().getNext() != null && var1.getNext().getNext().getNext().getNext().getNext().getInstruction() instanceof POP2;
    }

    private boolean method1763(Vector var1) {
        int var2;
        for (int var10000 = var2 = var1.size() - 1; var10000 >= 0; var10000 = var2) {
            InstructionList var4 = Class171.method1704((Class171) var1.get(var2)).getInstructionList();
    ...
    private short[] method1764(String var1) throws Exception {
        ...
        byte[] var7 = this.aString891.getBytes();
        ...
        int var10;
        for (var10000 = var10 = (int) ((double) var3 * (0.666D + Class34.method566() / 3.0D)) + 113; var10000 % 4 != 0; var10000 = var10) {
            ++var10;
        }
        ...
        boolean var14 = false;
        short var23 = (short) (this.aString891.hashCode());
        var13.put(var23, "");
        ...
        int var17 = this.aString891.hashCode();
    ...
    private String method1765(short[] var1) throws Exception {
        ...
        int var16 = this.aString891.hashCode();
        byte var17 = 0;
        byte var18 = 0;
        ...
        if (var19 == -1) {
            ...
            byte[] var13 = this.aString891.getBytes();
