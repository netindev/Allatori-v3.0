...
public class LogFile {
    ...
    public static void writeLogFile() {
        ...
        if ((var0 = Class57.method710()) == null) {
            ...
            try {
                ...
                writeXMLHeader(var1 = new PrintWriter(new BufferedWriter(new OutputStreamWriter(var2, "UTF-8"), 262144)));
    ...
    private static int method1770(Vector var0, String var1) {
        ...
        for (int var10000 = var2; var10000 <= var3; var10000 = var2) {
            ...
            int var6 = ((Comparable) var0.get(var4)).compareTo(var1);
            if (var6 < 0) {
                var2 = var4 + 1;
            } else {
                if (var6 <= 0) {
    ...
    private static void writeMapping(PrintWriter var0, Class5 var1) {
        ...
        Vector var2 = new Vector(var1.aRenamingMap_512.method444());
        Vector var3 = new Vector(var1.aRenamingMap_514.method444());
        Vector var4 = new Vector(var1.aRenamingMap_516.method444());
        ...
        for (var10000 = var5 = var2.size() - 1; var10000 >= 0; var10000 = var5) {
            ...
            for (var10000 = var8 = method1770(var3, var7); var10000 < var3.size() && (var9 = (String) var3.get(var8)).startsWith(var7); var10000 = var8) {
            ...
            for (var10000 = var8 = method1770(var4, var7); var10000 < var4.size() && (var9 = (String) var4.get(var8)).startsWith(var7); var10000 = var8) {
                var10 = var9.substring(var9.indexOf("&") + 1, var9.lastIndexOf("&"));
                var11 = var9.substring(var9.lastIndexOf("&") + 1);
        ...
        if ((var12 = new Vector(var1.aRenamingMap_513.method444())).size() > 0) {
            ...
            for (var10000 = var13 = var12.size() - 1; var10000 >= 0; var10000 = var13) {
                ...
                var0.println("   <annotation oldClassName=\"" + var11 + "\" oldMethodName=\"" + var10 + "\" newMethodName=\"" + var9 + "\"/>");
                --var13;
            }
        ...
        for (var10000 = var13 = var1.aVector515.size() - 1; var10000 >= 0; var10000 = var13) {
            Class118 var15 = (Class118) var1.aVector515.get(var13);
