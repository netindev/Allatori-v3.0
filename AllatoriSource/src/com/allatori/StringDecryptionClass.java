...
public class StringDecryptionClass {
	...
	public static String decrypt(String var0) {
		...
		final char[] var10002 = new char[var0.length()];
		int var3;
	...
	public static String decrypt2(String var0) {
		final StackTraceElement var10003 = (new Exception()).getStackTrace()[1];
		final String var10004 = var10003.getClassName() + var10003.getMethodName();
		int var3;
		int var4 = var3 = var10004.length() - 1;
		final int var10001 = var0.length();
		final char[] var5 = new char[var10001];
		char var6 = 85;

		for (int var7 = var10001 - 1; var7 >= 0; --var7) {
			final char var10005 = var10004.charAt(var4);
